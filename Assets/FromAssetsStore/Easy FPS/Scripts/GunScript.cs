...
public class GunScript : MonoBehaviour {
	...
	void Awake()
	{
		...
		// Add to AudioMixer group
		hitMarker.outputAudioMixerGroup = volume;
		shoot_sound_source.outputAudioMixerGroup = volume;
		reloadSound_source.outputAudioMixerGroup = volume;
